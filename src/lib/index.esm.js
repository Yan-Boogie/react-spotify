import f, { createContext, useState, useContext, useEffect } from 'react';
...
const UserTokenContext = createContext('User-Token-Context');
...
function useSpotifyApiRequest({ requestUrl, requestMethod, }) {
    ...
    const [apiReturned, setApiReturned] = useState(null);
...
export { useSpotify, useSpotifyApiRequest };
